          ...
          switch (tryElementName.getResult()) {
            case "someBools":
            {
              final Reporting.Result<List<Boolean>> trySomeBools = parseList(
                ...
                isEmptyProperty,
                Boolean.class,
                itemReader -> tryNamedElementAsBoolean(itemReader, "v"));
            ...
            case "someInts":
            {
              final Reporting.Result<List<Long>> trySomeInts = parseList(
                ...
                isEmptyProperty,
                Long.class,
                itemReader -> tryNamedElementAsLong(itemReader, "v"));
            ...
            case "someFloats":
            {
              final Reporting.Result<List<Double>> trySomeFloats = parseList(
                ...
                isEmptyProperty,
                Double.class,
                itemReader -> tryNamedElementAsDouble(itemReader, "v"));
            ...
            case "someStrings":
            {
              final Reporting.Result<List<String>> trySomeStrings = parseList(
                ...
                isEmptyProperty,
                String.class,
                itemReader -> tryNamedElementAsString(itemReader, "v"));
            ...
            case "someBytes":
            {
              final Reporting.Result<List<byte[]>> trySomeBytes = parseList(
                ...
                isEmptyProperty,
                byte[].class,
                itemReader -> tryNamedElementAsBytes(itemReader, "v"));
