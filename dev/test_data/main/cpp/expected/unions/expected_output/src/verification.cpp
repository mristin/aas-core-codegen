...
void OfStructuralFirst::Next() {
  throw std::logic_error(
    "You want to move "
    "a verificator OfStructuralFirst, "
...
void OfStructuralSecond::Next() {
  throw std::logic_error(
    "You want to move "
    "a verificator OfStructuralSecond, "
    "but the verificator is always done as "
    "IStructuralSecond "
    "has no invariants defined."
  );
...
void OfMixedAbstractDescendantOne::Next() {
  throw std::logic_error(
    "You want to move "
    "a verificator OfMixedAbstractDescendantOne, "
    "but the verificator is always done as "
...
void OfMixedAbstractDescendantTwo::Next() {
  throw std::logic_error(
    "You want to move "
    "a verificator OfMixedAbstractDescendantTwo, "
    "but the verificator is always done as "
...
void OfMixedConcreteWithDescendants::Next() {
  throw std::logic_error(
    "You want to move "
    "a verificator OfMixedConcreteWithDescendants, "
    "but the verificator is always done as "
...
void OfMixedConcreteWithDescendantsChild::Next() {
  throw std::logic_error(
    "You want to move "
    "a verificator OfMixedConcreteWithDescendantsChild, "
    "but the verificator is always done as "
...
void OfMixedConcreteLeaf::Next() {
  throw std::logic_error(
    "You want to move "
    "a verificator OfMixedConcreteLeaf, "
    "but the verificator is always done as "
    "IMixedConcreteLeaf "
    "has no invariants defined."
  );
...
void OfModelTypedFirst::Next() {
  throw std::logic_error(
    "You want to move "
    "a verificator OfModelTypedFirst, "
    "but the verificator is always done as "
    "IModelTypedFirst "
    "has no invariants defined."
  );
...
void OfModelTypedSecond::Next() {
  throw std::logic_error(
    "You want to move "
    "a verificator OfModelTypedSecond, "
    "but the verificator is always done as "
    "IModelTypedSecond "
    "has no invariants defined."
  );
